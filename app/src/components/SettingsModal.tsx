...
export function SettingsModal({
  ...
  useEffect(() => {
    setStabilityApiKey(settings.stabilityApiKey);
  }, [settings.stabilityApiKey]);
  ...
  const getProviderStatus = (
    ...
    // stability
    // Stability can work without user key if server has env key
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-gray-600">
                        Configure upscaling providers. Drag to reorder priority
                        - enabled providers are tried in order from top to
                        bottom.
                      </p>
                    </div>
                          ...
                          <div className="space-y-2">
                            {settings.upscaleProviders.map((provider) => (
                              <SortableProviderItem
                                ...
                                provider={provider}
                                isConfigOpen={
                                  openConfigProvider === provider.id
                                }
                    ...
                    {openConfigProvider === "ai3" && (
                      <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500">
                            URL of the AI3 upscale daemon. Supports 2x and 4x
                            upscaling.
                          </p>
                        </div>
                      </div>
                    ...
                    {openConfigProvider === "stability" && (
                      <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500">
                            Your Stability AI API key. Leave empty to use server
                            environment variable. Fast upscale is always 4x.
                          </p>
                        </div>
                      </div>
                    )}
